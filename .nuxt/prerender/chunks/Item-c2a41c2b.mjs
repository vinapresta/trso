import { _ as _export_sfc, c as useRoute, u as useI18n, a as __nuxt_component_2 } from './server.mjs';
import { _ as __nuxt_component_1 } from './nuxt-img-e4923e79.mjs';
import { _ as _sfc_main$1 } from './Heading-d8708ed8.mjs';
import { reactive, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file://D:/dev/trso/app/node_modules/vue/index.mjs';
import { u as useLocalePath } from './composables-10605620.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'file://D:/dev/trso/app/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span data-v-f6f8bc49${_scopeId2}>${ssrInterpolate(unref(langAttr).title)}\xA0</span><span class="text-sm" data-v-f6f8bc49${_scopeId2}>(${ssrInterpolate(__props.itemData.attributes.year)})</span>`);
                } else {
                  return [
                    createVNode("span", null, toDisplayString(unref(langAttr).title) + "\xA0", 1),
            ...
            if (__props.itemData.attributes.director != "N/A") {
              ...
              if (__props.type === "series") {
                ...
                _push2(`<span data-v-f6f8bc49${_scopeId}>${ssrInterpolate(_ctx.$t("pages.slug.directedMovie"))}\xA0</span>`);
              }
            ...
            return [
              ...
              __props.itemData.attributes.director != "N/A" ? (openBlock(), createBlock("span", {
                ...
                __props.type === "series" ? (openBlock(), createBlock("span", { key: 0 }, toDisplayString(_ctx.$t("pages.slug.directedSeries")), 1)) : (openBlock(), createBlock("span", { key: 1 }, toDisplayString(_ctx.$t("pages.slug.directedMovie")) + "\xA0", 1)),
      ...
      if (__props.type === "tv-series") {
        _push(`<span data-v-f6f8bc49>${ssrInterpolate(_ctx.$t("pages.slug.theSeries"))}\xA0</span>`);
      } else {
        _push(`<span data-v-f6f8bc49>${ssrInterpolate(_ctx.$t("pages.slug.theMovie"))}\xA0</span>`);
      }
      _push(`<span data-v-f6f8bc49>${ssrInterpolate(_ctx.$t("pages.slug.from"))}\xA0</span>`);
      if (unref(firstBook)) {
        ...
        if (unref(firstBook).attributes.authors.length) {
          _push(`<span class="block py-2 text-xs italic" data-v-f6f8bc49><span data-v-f6f8bc49>${ssrInterpolate(_ctx.$t("list.written"))}\xA0</span><!--[-->`);
...
//# sourceMappingURL=Item-c2a41c2b.mjs.map
