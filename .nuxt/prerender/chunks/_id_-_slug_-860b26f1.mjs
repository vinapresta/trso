...
import { _ as _sfc_main$9 } from './Breadcrumbs-8a756e76.mjs';
import { withAsyncContext, computed, unref, useSSRContext, ref, resolveComponent, mergeProps, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, toDisplayString } from 'file://D:/dev/trso/app/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderVNode, ssrRenderSlot } from 'file://D:/dev/trso/app/node_modules/vue/server-renderer/index.mjs';
import { u as useI18n, b as useRuntimeConfig, c as useRoute, f as useNuxtApp, _ as _export_sfc } from './server.mjs';
import { u as useHead, _ as __nuxt_component_1$1 } from './nuxt-img-e4923e79.mjs';
import { u as useFetch } from './fetch-81eb1216.mjs';
...
import './composables-10605620.mjs';
...
const _imports_0 = "" + buildAssetsURL("image-not-available.7d3a20b6.jpg");
const _sfc_main$2 = {
  __name: "Detail",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.itemAttr.ratings, (rating) => {
        _push(`<li><span class="italic pb-2">${ssrInterpolate(rating.Source)}:</span>\xA0 <span class="${ssrRenderClass([`text-trso-${unref(color)}`, "font-semibold"])}">${ssrInterpolate(rating.Value)}</span></li>`);
      });
      _push(`<!--]--></ul></div></div>`);
    };
  }
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(item).firstBook.attributes.authors) {
        _push(`<span class="block pb-2 md:pb-4 italic text-base lg:text-lg" itemprop="author"><span>${ssrInterpolate(_ctx.$t("pages.slug.by"))}\xA0</span><!--[-->`);
...
//# sourceMappingURL=_id_-_slug_-860b26f1.mjs.map
