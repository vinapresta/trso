...
import { useSSRContext, ref, onBeforeUnmount, computed, unref, withCtx, createVNode, toDisplayString, mergeProps, reactive, watch, createTextVNode, openBlock, createBlock, createCommentVNode, withAsyncContext } from 'file://D:/dev/trso/app/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderStyle, ssrRenderSlot, ssrIncludeBooleanAttr } from 'file://D:/dev/trso/app/node_modules/vue/server-renderer/index.mjs';
import { u as useI18n, c as useRoute, d as useRouter, e as useState, a as __nuxt_component_2, _ as _export_sfc, b as useRuntimeConfig, f as useNuxtApp } from './server.mjs';
import { u as useLocalePath, a as useRouteBaseName } from './composables-10605620.mjs';
import { _ as __nuxt_component_2$1 } from './Plus-5962bd90.mjs';
import { u as useFetch } from './fetch-81eb1216.mjs';
import { _ as __nuxt_component_3$1 } from './ArrowRight-ca1db586.mjs';
...
const _imports_0 = "" + publicAssetsURL("img/logo_white_resize.png");
const _sfc_main$b = {
  __name: "HeaderNav",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Tarseroo.com \xA92023`);
          } else {
            return [
              createTextVNode("Tarseroo.com \xA92023")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=error-component-8e0514eb.mjs.map
