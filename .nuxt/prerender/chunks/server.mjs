...
import { useRoute as useRoute$1, useRouter as useRouter$1, RouterView, createMemoryHistory, createRouter } from 'file://D:/dev/trso/app/node_modules/vue-router/dist/vue-router.node.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./_id_-_slug_-860b26f1.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    component: () => import('./privacy-policy-d9f9c7a9.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_search_-6d478674.mjs').then((m) => m.default || m)
  }
];
...
function useRouteBaseName(givenRoute = useRoute$1(), { router = useRouter$1(), routesNameSeparator = void 0 } = {}) {
  const proxy = {
    router,
    route: givenRoute,
    routesNameSeparator
...
export { _export_sfc as _, __nuxt_component_2 as a, useRuntimeConfig as b, useRoute as c, useRouter as d, entry$1 as default, useState as e, useNuxtApp as f, getComposer as g, useLocalePath as h, useRouteBaseName as i, createError as j, useRequestFetch as k, useRequestEvent as l, parseSize as p, useI18n as u };
