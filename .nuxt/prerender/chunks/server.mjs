import { getCurrentInstance, version, toRef, isRef, inject, defineComponent, h, onUnmounted, computed, unref, Suspense, nextTick, Transition, provide, reactive, shallowRef, isReadonly, ref, resolveComponent, watch, Fragment as Fragment$1, useSSRContext, createApp, effectScope, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, Text, withCtx } from 'file://D:/dev/trso/app/node_modules/vue/index.mjs';
import { $fetch } from 'file://D:/dev/trso/app/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file://D:/dev/trso/app/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://D:/dev/trso/app/node_modules/unctx/dist/index.mjs';
import { useHead, createHead as createHead$1 } from 'file://D:/dev/trso/app/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file://D:/dev/trso/app/node_modules/@unhead/dom/dist/index.mjs';
import { renderSSRHead } from 'file://D:/dev/trso/app/node_modules/@unhead/ssr/dist/index.mjs';
import { useRouter as useRouter$1, useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter } from 'file://D:/dev/trso/app/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sendRedirect } from 'file://D:/dev/trso/app/node_modules/h3/dist/index.mjs';
import { isEqual, hasProtocol, encodeParam, joinURL, withLeadingSlash, parseURL, encodePath } from 'file://D:/dev/trso/app/node_modules/ufo/dist/index.mjs';
import { CoreWarnCodes, CompileErrorCodes, registerMessageResolver, resolveValue, registerLocaleFallbacker, fallbackWithLocaleChain, setDevToolsHook, createCompileError, DEFAULT_LOCALE as DEFAULT_LOCALE$1, updateFallbackLocale, NUMBER_FORMAT_OPTIONS_KEYS, DATETIME_FORMAT_OPTIONS_KEYS, setFallbackContext, createCoreContext, clearDateTimeFormat, clearNumberFormat, setAdditionalMeta, getFallbackContext, NOT_REOSLVED, isTranslateFallbackWarn, isTranslateMissingWarn, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number } from 'file://D:/dev/trso/app/node_modules/@intlify/core-base/dist/core-base.mjs';
import { setupDevtoolsPlugin } from 'file://D:/dev/trso/app/node_modules/vue-devtools-stub/dist/index.mjs';
import { VueDevToolsLabels, VueDevToolsPlaceholders, VueDevToolsTimelineColors } from 'file://D:/dev/trso/app/node_modules/@intlify/vue-devtools/dist/vue-devtools.mjs';
import { parse, serialize } from 'file://D:/dev/trso/app/node_modules/cookie-es/dist/index.mjs';
...
import { createInMemoryCache } from 'file://D:/dev/trso/app/node_modules/@algolia/cache-in-memory/index.js';
import VueSocialSharing from 'file://D:/dev/trso/app/node_modules/vue-social-sharing/dist/vue-social-sharing.js';
import { ssrRenderSuspense, ssrRenderComponent } from 'file://D:/dev/trso/app/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.name) ?? "type-id-slug___en",
    path: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.path) ?? "/:type/:id-:slug",
    children: [],
    meta: __nuxt_page_meta$4,
    alias: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.alias) || [],
    redirect: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.redirect) || void 0,
    component: () => import('./_id_-_slug_-fddf9fbe.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) ?? "type-pages-page___en",
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/:type/pages/:page",
    children: [],
    meta: __nuxt_page_meta$3,
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./_page_-7be7fd55.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-42cb651d.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "privacy-policy___en",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/privacy-policy",
    children: [],
    url: "/privacy-policy",
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./privacy-policy-28aca793.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "search-search___en",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/search/:search",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_search_-6b2cffe3.mjs').then((m) => m.default || m)
  }
];
...
const __nuxt_component_2 = defineNuxtLink({ componentName: "NuxtLink" });
...
const additionalMessages = Object({ "en": [] });
const resolveNuxtI18nOptions = async (context) => {
  ...
  nuxtI18nOptions.locales = [Object({ "code": "en", "iso": "en-US", "file": "en.js" })];
  ...
  nuxtI18nOptions.pages = Object({ "index": Object({ "en": "/" }), "[type]/[id]-[slug]": Object({ "en": "/[type]/[id]-[slug]" }), "[type]/pages/[page]": Object({ "en": "/[type]/pages/[page]" }), "search/[search]": Object({ "en": "/search/[search]" }), "privacy-policy": Object({ "en": "/privacy-policy" }) });
...
function getBrowserLocale(options, context) {
  let ret;
  {
    const header2 = useRequestHeaders(["accept-language"]);
    const accept = header2["accept-language"];
    if (accept) {
...
function getHost() {
  let host;
  {
    const header2 = useRequestHeaders(["x-forwarded-host", "host"]);
    let detectedHost;
    if ("x-forwarded-host" in header2) {
      detectedHost = header2["x-forwarded-host"];
    } else if ("host" in header2) {
      detectedHost = header2["host"];
    }
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file://D:/dev/trso/app/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
function createImage(globalOptions) {
  ...
  const getImage2 = (input, options = {}) => {
    const image2 = resolveImage(ctx, input, options);
    return image2;
  };
...
async function getMeta(ctx, input, options) {
  const image2 = resolveImage(ctx, input, { ...options });
  if (typeof image2.getMeta === "function") {
    return await image2.getMeta();
  } else {
    return await imageMeta(ctx, image2.url);
  }
}
function resolveImage(ctx, input, options) {
  ...
  const image2 = provider.getImage(input, _options, ctx);
  image2.format = image2.format || expectedFormat || "";
  return image2;
}
...
const ipxRuntime$DvQGZMr6fq = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$DvQGZMr6fq, defaults: {} }
};
...
const plugin_BqLkNUef68 = defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
...
const firestore_YiOudWkT8Q = defineNuxtPlugin((nuxtApp) => {
  useRuntimeConfig();
  const db = "";
  return {
    provide: {
...
const format_date_C2QjBefQr2 = defineNuxtPlugin(() => {
  return {
    provide: {
...
const header = {
  movies: "Movies based on a book",
  series: "TV series based on a book",
  search: "search",
  closeSearch: "close search"
};
const vote = {
  titleMovie: "Was the movie well adapted?",
  titleSeries: "Was the series well adapted?"
};
const footer = {
  contact: "Contact us",
  ...
  contactModal: {
    ...
    errorMessage: "The message is not valid.",
...
const image = {
  na: "Image not available"
};
const pages = {
  home: {
    title: "homepage - find what books your favorite movies and TV series are based on!",
    rated: "Best rated movies",
    hidDescription: "List all the movies and series based on a book. Search for a movie or a series and find what book it is based on.",
    hidKeywords: "movie, movies, based on, series, book, books, novel, novels, read, reader, reading, script, movie script, series script, scenario, movie material, movie writer, series material, series writer, original story",
    hidOgDescription: "List all the movies and series based on a book. Search for a movie or a series and find what book it is based on.",
    hidTwitterTitle: "find what books your favorite movies and series are based on!",
    hidTwitterDescription: "List all the movies and series based on a book. Search for a movie or a series and find what book it is based on.",
    disclaimer1: "Behind most of the greatest movies or series, there are great writers.",
    disclaimer2: "Our website is a great destination for book lovers and fans of movies and TV series!",
    disclaimer3: "We aim to provide a platform that makes it easy to find the perfect book that complements your favorite movie or TV show.",
    disclaimer4: "Explore our website or use our search bar and let us help you discover your next favorite book based on what you like on screen!"
  },
  search: {
    title: "Results for the search",
    result: "There is 1 result for",
    resultsP1: "There are",
    resultsP2: "results for",
    noResults: "There are no results for",
    goTo: "See the information about",
    placeholder: "",
    loadMore: "Load more results",
    noMore: "There are no more results.",
    moviesList: "See the list of all movies based on a book",
    seriesList: "See the list of all TV series based on a book"
  },
  movies: {
    title: "List of movies based on a book",
    empty: "There are no movies for the moment.",
    hidDescription: "List of movies based on a book - page",
    hidKeywords: "movie, movies, based on, series, book, books, novel, novels, read, reader, reading, script, movie script, scenario, movie material, movie writer, original story",
    hidOgDescription: "List of movies based on a book - page",
    hidTwitterTitle: "find what books your favorite movies are based on!",
    hidTwitterDescription: "List of movies based on a book - page"
  },
  series: {
    title: "List of TV series based on a book",
    empty: "There are no TV series for the moment.",
    hidDescription: "List of TV series based on a book - page",
    hidKeywords: "TV series, based on, series, book, books, novel, novels, read, reader, reading script, series script, scenario, series material, series writer, original story",
    hidOgDescription: "List of TV series based on a book - page",
    hidTwitterTitle: "find what books your favorite TV series are based on!",
    hidTwitterDescription: "List of TV series based on a book - page "
  },
  slug: {
    metaTitle: "What book is the {type} {title} is based on?",
    the: "the",
    what: "What book is",
    on: "based on?",
    directedMovie: "directed by",
    directedSeries: "directed by",
    by: "written by",
    buy: "Find this book on Amazon.",
    theMovie: "The movie",
    theSeries: "The TV series",
    and: "and",
    released: "released in",
    from: "is based on the book",
    more: "Read more",
    less: "Show less",
    find: "find",
    written: "Written by",
    ...
    hidDescription1: "Did you know that the",
    hidDescription2: "is based on the book",
    hidKeywords: "movie, movies, based on, series, book, books, novel, novels, read, reader, reading, movie material, movie writer, series material, series writer, script, scenario, original story",
    hidOgDescription: "is based on the book",
    hidTwitterDescription: "is based on the book",
    socialTitle1: "the movie",
    socialTitle2: "is based on the book",
    socialDescription1: "Did you know that",
    socialDescription2: "is based on the book",
    socialDescription3: "written by",
    socialDescription4: "Easily find which books are the source material of the movies and tv series you love! Check our website!",
    bookImgAlt: "Cover of the book",
    bookRating: "This book was rated",
    googleBooks: "on Google books.",
    published: "Published by",
    relatedBooks: "Related books / From the author(s)",
    comments: "Do you want to have more information about",
    comments2: "or tell what you think about the book adaptation? Leave a comment."
  },
  privacy: {
    title: "Privacy policy",
    content: "This website doesn't collect personal data."
  }
};
const movie = {
...
const components = {
  featured: {
    topMovies: "Popular movies based on a book",
    topMovies2: "See the list of all movies based on a book",
    topSeries: "Popular TV series based on a book",
    topSeries2: "See the list of all TV series based on a book"
  },
  item: {
    linkTitle: "See details about the {type} {name} based on the book {book}"
  },
  pagination: {
    first: "first",
    last: "last",
  ...
  search: {
    title: "What book is your favorite movie or Tv series based on?",
    placeholder: "Type a movie or a TV series title",
    more: "See more results",
    empty: "No Results for this search term.",
    madeWith: "This search is made with"
  },
  formsContact: {
    title: "Contact us",
    ...
    messagePlaceholder: "Any questions or observations?",
    emailError: "A valid email address is required.",
    messageError: "A valid message is required.",
...
const error = {
  ...
  series: "See the list of all movies based on a book",
  movies: "See the list of all movies based on a book"
};
const en = {
  header,
  vote,
...
const social_share_Daw24WAz69 = defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(VueSocialSharing);
});
const validate_email_t2pkAfA0l9 = defineNuxtPlugin(() => {
  return {
    provide: {
      validateEmail: (email) => {
...
const _plugins = [
  ...
  plugin_OrkQhMqHci,
  plugin_BqLkNUef68,
  firestore_YiOudWkT8Q,
  format_date_C2QjBefQr2,
  i18n_VfGcjrvSkj,
  social_share_Daw24WAz69,
  validate_email_t2pkAfA0l9
];
...
const layouts = {
  default: () => import('./default-f505b3cc.mjs').then((m) => m.default || m),
  error: () => import('./error-771ad916.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component-8c664960.mjs').then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import('./island-renderer-87f7a36d.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { __nuxt_component_2 as _, _export_sfc as a, useRuntimeConfig as b, useRoute as c, useRouter as d, entry$1 as default, useState as e, useNuxtApp as f, getComposer as g, useLocalePath as h, createError as i, useRequestFetch as j, useRequestEvent as k, parseSize as p, useI18n as u };
