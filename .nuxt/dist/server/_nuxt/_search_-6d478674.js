...
import { useSSRContext, mergeProps, defineComponent, computed, ref, reactive, withCtx, unref, openBlock, createBlock, toDisplayString, createTextVNode, createVNode, createCommentVNode } from "vue";
...
import { _ as _export_sfc, f as useNuxtApp, b as useRuntimeConfig, e as useState, u as useI18n, c as useRoute, a as __nuxt_component_2 } from "../server.mjs";
...
const _search__vue_vue_type_style_index_0_scoped_462d5cd0_lang = "";
const _sfc_main = {
  __name: "[search]",
  __ssrInlineRender: true,
  setup(__props) {
      ...
      _push(ssrRenderComponent(_component_HelpersHeading, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`   <span class="italic font-semibold" data-v-462d5cd0${_scopeId}>${ssrInterpolate(unref(customSearch))}</span>`);
          } else {
            return [
...
//# sourceMappingURL=_search_-6d478674.js.map
