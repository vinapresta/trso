import { getCurrentScope, onScopeDispose, unref, computed, ref, getCurrentInstance, nextTick, watchEffect, watch, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="h-[0px] w-full" id="menuObserver"></div><div class="container px-2 md:px-4 min-h-[90vh] max-w-7xl mb-16" style="${ssrRenderStyle(unref(miniHeader) || !unref(isLargeScreen) ? `padding-top: calc(${unref(height)}px + 2rem)` : "")}">`);
...
//# sourceMappingURL=default-cdfe2549.js.map
