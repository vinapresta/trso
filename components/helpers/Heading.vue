...
<script setup>
    ...
    const props = defineProps({
        ...
        tagStyle: {
            ...
            required: false,
            default: 'h1',
            validator: (value) => ['h1', 'h2', 'h3', 'h4', 'item', 'pageTitle'].includes(value),
        },
        color: String
    })
    ...
    const classes = computed(() => {
        ...
        const styleClasses = {
            h1: `uppercase pb-4 md:pb-8 text-2xl font-medium font-[title] text-trso-${props.color} tracking-tighter leading-none`,
            h2: `pb-2 md:pb-4 text-2xl text-trso-${props.color} font-medium tracking-tighter leading-none`,
